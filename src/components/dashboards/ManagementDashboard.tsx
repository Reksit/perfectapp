                ...
                {eventTabs.map((tab, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`whitespace-nowrap py-4 px-6 font-medium text-sm flex items-center space-x-2 transition-all duration-300 flex-shrink-0 ${
                        eventTab === tab.id
                        ...
                        <div className="p-2">
                          ...
                          >
                            <div className="flex items-start space-x-3">
                              <UserCheck className="h-5 w-5 text-orange-500 mt-0.5" />
                              <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <UserCheck className="h-8 w-8 text-purple-600 mb-2 group-hover:scale-110 transition-transform" />
            ...
            >
              <Activity className="h-8 w-8 text-blue-600 mb-2 group-hover:scale-110 transition-transform" />
              <span className="text-sm font-medium text-gray-700 text-center">
                Student Activity
              </span>
            </button>
